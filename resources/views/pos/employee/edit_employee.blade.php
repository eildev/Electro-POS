...
<div class="card">
	<div class="card-body">
		<h6 class="card-title text-info">Edit Employee</h6>
			<form id="myValidForm" action="{{route('employee.update',$employees->id)}}" method="post" enctype="multipart/form-data" >
				@csrf
				<div class="row">
					<!-- Col -->
					<div class="col-sm-6">
						<div class="mb-3 form-valid-groups">
							...
							<input type="text" name="full_name" value="{{$employees->full_name}}" class="form-control field_required" placeholder="Enter Employee name">
						</div>
					</div><!-- Col -->
					<div class="col-sm-6">
						<div class="mb-3 form-valid-groups">
							<label class="form-label">Phone<span class="text-danger">*</span></label>
							<input type="text" name="phone" value="{{$employees->phone}}" class="form-control" placeholder="Enter Employee Number">
						</div>
					</div>
					<div class="col-sm-6 form-valid-group">
						<div class="mb-3">
							<label class="form-label">Email address<span class="text-danger">*</span></label>
							<input type="email" name="email" value="{{$employees->email}}" class="form-control" placeholder="Enter Employee email">
						</div>
					</div><!-- Col -->
					<div class="col-sm-6">
						<div class="mb-3">
				...
				<div class="row">
					<div class="col-sm-4 form-valid-group">
						<div class="mb-3">
							...
							<input type="number" class="form-control" name="nid" value="{{$employees->nid}}"  placeholder="Enter NID Number">
						</div>
					</div><!-- Col -->
					<div class="col-sm-4 form-valid-group">
						<div class="mb-3">
							<label class="form-label">Designation</label>
							<input type="text" name="designation" class="form-control" value="{{$employees->designation}}" placeholder="Enter Employee Designation">
						</div>
					</div><!-- Col -->
					<div class="col-sm-4 form-valid-group">
						<div class="mb-3">
							<label class="form-label">Employee Salary</label>
							<input type="number" class="form-control" name="salary" value="{{$employees->salary}}" placeholder="Enter Employee Salary">
						</div>
					</div><!-- Col -->
				</div><!-- Row -->
				<div class="row">
